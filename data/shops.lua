return {
	Pawnshop = {
		...
		blip = {
			...
			{name = 'phone', price = 10},
			{name = 'binoculars', price = 10},
			{name = 'radio', price = 10},
		}, locations = {
			vec3(25.7, -1347.3, 29.49),
		}, targets = {
			{ loc = vec3(451.64, -1473.08, 28.29), length = 2.0, width = 0.7, heading = 65, minZ = 28.29, maxZ = 30.29, distance = 1.5 },
		}
	},
	...
	VendingMachineDrinks = {
		...
		model = {
			`prop_vend_soda_02`, `prop_vend_water_01`, `prop_vend_soda_01` --`prop_vend_fridge01`
		}
	}
}
